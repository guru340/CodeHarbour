...
const ProjectDetail = () => {
  ...
  // Create new issue in a column
  const handleCreateIssue = (status) => {
      ...
      <ScrollArea className="h-screen pr-2">
        ...
        <section>
          ...
          <div className='lg:flex md:flex gap-3 justify-between py-5'>
            <IssueList status="pending"     title="Todo List"   issues={issues.pending}     onCreateIssue={handleCreateIssue} onDeleteIssue={handleDeleteIssue} onChangeAssignee={handleChangeAssignee} onChangeStatus={handleChangeStatus} />
            <IssueList status="in_progress" title="In Progress" issues={issues.in_progress} onCreateIssue={handleCreateIssue} onDeleteIssue={handleDeleteIssue} onChangeAssignee={handleChangeAssignee} onChangeStatus={handleChangeStatus} />
            <IssueList status="done"        title="Done"        issues={issues.done}        onCreateIssue={handleCreateIssue} onDeleteIssue={handleDeleteIssue} onChangeAssignee={handleChangeAssignee} onChangeStatus={handleChangeStatus} />
          </div>
        </section>
