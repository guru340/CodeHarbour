...
const IssueList = ({ status, title, issues, onCreateIssue, onDeleteIssue, onChangeAssignee, onChangeStatus }) => {
  ...
  return (
    <div className='min-w-[270px] w-[270px] bg-[#131525] border border-[#252a45] rounded-xl p-4 flex flex-col gap-3'>
      ...
      {issues.map((issue) => (
        <Card
          key={issue.id}
          className='bg-[#0e0f1f] border border-[#252a45] p-3 hover:border-indigo-500/50 transition-colors cursor-pointer'
        >
