...
import { FETCH_PROJECT_BY_ID_REQUEST, FETCH_PROJECT_REQUEST, INVITE_TO_PROJECT_REQUEST } from "./ActionTypes";
import { ACCEPT_INVITATION_REQUEST, DELETE_PROJECT_REQUEST } from "./ActionTypes";
import { FETCH_PROJECTS_BY_ID_SUCCESS,FETCH_PROJECT_SUCCESS     } from "./ActionTypes";
const intialState={
    projects:[],
    loading:false,
    error:null,
